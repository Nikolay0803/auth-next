  ...
  return (
    <div className="max-w-7xl mx-auto px-4 pb-[60px] sm:px-6 lg:px-8">
      {teachers.map((teacher, index) => (
        <div key={index} className="bg-white p-6 rounded-3xl flex gap-12 mb-8">
          ...
          <div>
            <div className="flex gap-[149px] mb-2">
              ...
              <ul className="flex gap-4 font-medium whitespace-nowrap">
                ...
                <li className="flex items-center gap-2 border-r border-gray-300">
                  <p className="pr-4">Lessons done: {teacher.lessonsDone}</p>
                </li>
                <li className="flex items-center gap-2 border-r border-gray-300">
                  <div className="w-4 h-4">
                    <Image src={star} alt="star" />
                  </div>
                  <p className="pr-4">Rating: {teacher.rating}</p>
                </li>
            ...
            <h2 className="text-2xl font-medium mb-8">{teacher.name}</h2>
            <ul className="flex flex-col gap-2 mb-4">
              <li className="text-[#8A8A89] font-medium">
                Speaks:{" "}
                <span className="text-[#121417] font-medium">
                  {teacher.speaks}
                </span>
              </li>
              <li className="text-[#8A8A89] font-medium">
            ...
            <button className="text-[#121417] font-medium underline mb-10">
              Read more
            </button>
